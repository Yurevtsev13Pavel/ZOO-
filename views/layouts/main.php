...
<header id="header">
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            ['label' => 'О нас', 'url' => ['/site/onas']],
            ['label' => 'Товары', 'url' => ['/site/about']],
            ['label' => 'Услуги', 'url' => ['/site/uslugi']],
            ['label' => 'Заказать услугу', 'url' => ['/site/application'], 'visible' => !Yii::$app->user->isGuest],
